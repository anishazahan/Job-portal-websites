...
<div className="py-6">
  <div className="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
        ...
        <div className="w-full p-8 lg:w-1/2">
            ...
            <Link to='/</div>' className="flex items-center justify-center mt-4 text-white rounded-lg shadow-md hover:bg-gray-100">
            ...
            <div className="mt-4">
                <div className="flex justify-between">
                    ...
                    <Link to = '/' href="#" className="text-xs text-gray-500">Forget Password?</Link>
                </div>
